...
foreach ($lineas as $linea) {
    ...
    if ($registro[0] != "") {
        $id=$registro[0];
        $registro = ['numero_cuenta' => $registro[1],'banco' => $registro[2] ];
...
if (file_exists($archivo)) {
    ...
    $mensaje .= "Procesar Cuentas Inmuebles (".$items.")<br />";
    echo "Procesar archivo Cuentas Inmuebles (".$items.")<br />";
    foreach ($lineas as $linea) {
        $registro = explode("\t", $linea);
