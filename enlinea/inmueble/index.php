...
switch ($accion) {
    ...
    case "junta-condominio": default :
        ...
        if ($propiedades['suceed'] == true) {
            ...
            foreach ($propiedades['data'] as $propiedad) {
                ...
                if ($propiedad['id_inmueble'] != $id_inmueble) {
                    ...
                    if ( count($inmueble['data']) >0 ) {

                        $miembros[] = [ 'inmueble' => $inmueble['data'][0], 'miembros' => $junta['data'] ];
        ...
        $params = [
            ...
            'seccion'                => 'Integrantes Junta de Condominio',
            'session'                => $session,
        ];
        echo $twig->render('enlinea/inmueble/integrantes-junta-condominio.twig', $params);
        break; 
    ...
    case "estado-cuenta":
        ...
        $params =   [
                        ...
                        'promedio_cobranza'      => $promedio_cobranza,
                        'promedio_facturacion'   => $promedio_facturacion,
                        'seccion'                => 'Estado de Cuenta General',
                        'session'                => $session,
                    ];
        echo $twig->render( 'enlinea/inmueble/estado-de-cuenta.twig', $params );
        break; 
