...
$produccion     = HOSTNAME == "www.administradoranelu.com" | HOSTNAME == "administradoranelu.com";
$debug          = false;
$sistema        = "/";
$email_error    = true;
$mostrar_error  = true;
...
define("TITULO", "Administradora Anelu");
...
define("PORT",25);
define("USER_MAIL","no-contestar@administradoranelu.com");
define("PASS_MAIL","XZ6lj6i,!49X");
define("MESES_COBRANZA",2);
define("GRAFICO_FACTURACION",1);
define("GRAFICO_COBRANZA",1);
define("DEMO",0);
define("MOVIMIENTO_FONDO",0);
define("CORREO_CONTACTO",'adm.aneluca@gmail.com');
...
$tasa = json_decode(file_get_contents('https://www.pronet21.net/bcv'));
