...
class extensiones extends Twig_Extension {
    ...
    public static function spaceIzq($string) {
        return Misc::spaceIzq($string);
    }
    public static function formatAccount($string) {
        return Misc::formatAccount($string);
    }

    public static function format_mysql_number($str_number) {
        return Misc::format_mysql_number($str_number);
    }
    ...
    public function getFunctions() {
        return array(
            ...
            'spaceIzq'        => new Twig_Function_Method($this, 'spaceIzq'),
            'formatAccount'   => new Twig_Function_Method($this, 'formatAccount'),
            'format_mysql_number'   => new Twig_Function_Method($this, 'format_mysql_number'),
